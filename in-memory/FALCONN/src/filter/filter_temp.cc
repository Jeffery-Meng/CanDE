...
std::mt19937 rng;
int n, qn, dim, dim_Arows, dim_Frows, K, qn_real;
std::string data_filename, query_filename, kernel_filename;
std::ifstream data_in, query_in, kernel_in;
