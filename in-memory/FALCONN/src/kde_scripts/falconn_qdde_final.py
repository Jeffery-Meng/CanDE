...
modes = ["knn and qdde infer", "knn and qdde associative","knn and qdde precomputed"] #"knn and qdde infer", "knn and qdde associative","knn and qdde precomputed"
result_ends = ["infer","associative","precomputed"] # "infer","associative","precomputed"
