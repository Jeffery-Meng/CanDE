...
### How to use AXequaltoY distance searching?

Remember to set dimension as 2 plus the actual dimension: one additional dimension is used for homogenizing the searching problem, and the second is used to normalize the data.